...
### so have a template already made and filled out, just gets copied
...
def setup_loop_job(job_name, out_dir, input_file, material, rat_root, env_file, submission_dir):
    ...
    analyse_sh_name = "{0}/multipdf_analyse.sh".format(sh_dir)
